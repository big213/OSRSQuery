...
/**All Scalar values*/ export type Scalars = {
  ...
  prayerSortByKey: "id" | "createdAt" | "updatedAt";
  prayerGroupByKey: undefined;
};
/**All Input types*/ export type InputTypes = {
  ...
  prayer: { id?: Scalars["id"] };
  prayerSortByObject: SortByField<Scalars["prayerSortByKey"]>;
  "prayerFilterByField/id": FilterByField<Scalars["id"]>;
  "prayerFilterByField/createdBy.id": FilterByField<Scalars["id"]>;
  prayerFilterByObject: {
    id?: InputTypes["prayerFilterByField/id"];
    "createdBy.id"?: InputTypes["prayerFilterByField/createdBy.id"];
  };
  prayerPaginator: {
    first?: Scalars["number"];
    last?: Scalars["number"];
    after?: Scalars["string"];
    before?: Scalars["string"];
    sortBy?: InputTypes["prayerSortByObject"][];
    filterBy?: InputTypes["prayerFilterByObject"][];
    groupBy?: Scalars["prayerGroupByKey"][];
    search?: Scalars["string"];
  };
  createPrayer: {
    name: Scalars["string"];
  ...
  updatePrayer: {
    item: InputTypes["prayer"];
    fields: InputTypes["updatePrayerFields"];
  };
};
/**All main types*/ export type MainTypes = {
  ...
  prayerEdge: { Typename: "prayerEdge"; Type: GetType<PrayerEdge> };
  prayerPaginator: {
    Typename: "prayerPaginator";
    Type: GetType<PrayerPaginator>;
  };
  ...
  prayer: { Typename: "prayer"; Type: GetType<Prayer> };
};
...
export type PrayerEdge = Edge<Prayer>;
/**Paginator*/ export type PrayerPaginator = {
  /**The typename of the record*/ __typename: {
    Type: Scalars["string"];
    Args: [Scalars["number"]];
  };
  paginatorInfo: { Type: PaginatorInfo; Args: undefined };
  edges: { Type: PrayerEdge[]; Args: undefined };
};
...
/**Prayer type*/ export type Prayer = {
  /**The unique ID of the field*/ id: { Type: Scalars["id"]; Args: undefined };
  /**The typename of the record*/ __typename: {
    Type: Scalars["string"];
    Args: [Scalars["number"]];
...
/**All Root resolvers*/ export type Root = {
  ...
  getPrayer: { Type: Prayer; Args: InputTypes["prayer"] };
  getPrayerPaginator: {
    Type: PrayerPaginator;
    Args: InputTypes["prayerPaginator"];
  };
  deletePrayer: { Type: Prayer; Args: InputTypes["prayer"] };
  createPrayer: { Type: Prayer; Args: InputTypes["createPrayer"] };
  updatePrayer: { Type: Prayer; Args: InputTypes["updatePrayer"] };
};
